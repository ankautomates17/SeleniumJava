...
public class ReadPropFile {
	...
	public static void main(String[] args) throws IOException {
		...
		FileInputStream ip = new FileInputStream(
				"C:\\Users\\Ankit\\eclipse-workspace\\SeleniumJavaCourse\\src\\SeleniumSessions\\config.properties");
		...
		if (browserName.equals("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\Ankit\\Downloads\\geckodriver-v0.26.0-win64\\geckodriver.exe");
